...
public class GameRuleEngine {
    ...
    public boolean updateMoveAndCheckWinner(int row, int col, Piece piece, int n) {
        updateValue(row, col, piece, n);
    ...
    public void updateValue(int row, int col, Piece piece, int n) {
